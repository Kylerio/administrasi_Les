...
const Sidebar = () => {
    ...
    const SideBar_Links = [
        { id: 1, path:"/", name: "Dashboard", icon: IoNuclearSharp},
        { id: 2, path:"/profile", name: "Profile", icon: FaCircleUser},
        { id: 3, path:"/schedule", name: "Schedule", icon: RiCalendarScheduleFill},
        { id: 4, path:"/fee", name: "Fee", icon: FaMoneyBill},
    ]
